...
class Project(models.Model):
    name = models.CharField(max_length=64,unique=True,verbose_name=u'列表名')
    description = models.CharField(max_length=256,blank=True,null=True,verbose_name=u'项目')
...
class Contact(models.Model):
    name = models.CharField(max_length=64,unique=True,verbose_name=u'邮件名')
    email = models.CharField(max_length=256,blank=True,null=True,verbose_name=u'邮件号码')
...
class User(AbstractUser):
    ...
    # is_staff = models.BooleanField(default=True,verbose_name=u'进入管理')
